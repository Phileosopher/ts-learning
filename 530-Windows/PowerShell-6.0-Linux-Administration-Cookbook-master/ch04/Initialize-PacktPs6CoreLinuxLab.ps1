function Initialize-PacktPs6CoreLinuxLab {
    ...
    process {
        ...
        Invoke-WebRequest -Uri 'https://feeds.soundcloud.com/stream/265848849-wowamusik-piratosbeta.mp3' -OutFile (Join-Path -Path $Path -ChildPath piratos-wowa.me.mp3)
        ...
        Write-Host "`n`nCredits:`nCristian Ungureanu (https://mystock.photos/author/cristi/) for volcano.jpg and coffee.jpg`nSean Do (https://www.videezy.com/members/everywheresean) for matrix-like-wm.mp4`nWOWA (https://www.wowa.me/) for piratos-wowa.me.mp3`nAatur Harsh (https://unsplash.com/@aaturharsh) for bangalore.jpg`n"
    }
}
